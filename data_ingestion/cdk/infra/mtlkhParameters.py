...
env = "test"                     #Environment name dev,prod,stag
app = "SaaSApp"                     #App name

###   VPC Parameters   ###

cidrRange = "10.22.0.0/16"      #IPv4 CIDR range for VPC
...
# Availability zones will be dynamically determined based on current region
# az1 and az2 are now set in mtlkhEnvironment.py based on the stack's region
...
mskIamPropertyEnable = True               #Select True to enable (SASL/IAM) property for MSK Cluster otherwise False
...
enableSaslIAMClientAuth = False     #In the first iteration, disable SASL/IAM client authentication, and in the second iteration, enable it.
...
ec2InstanceClass = "MEMORY5"             #Instance class for EC2 instances
ec2InstanceSize = "XLARGE"                   #Size of the EC2 instance
...
producerEc2KeyPairName = "jp-custtest-key"